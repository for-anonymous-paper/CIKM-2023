...
if __name__ == "__main__":
    ...
    distance_gs, proximity_gs, sparsity_gs, aps_gs = stat(hepatitis_gs)
    distance_cfproto, proximity_cfproto, sparsity_cfproto, aps_cfproto = stat(hepatitis_cfproto)
    distance_plaincf, proximity_plaincf, sparsity_plaincf, aps_plaincf = stat(hepatitis_plaincf)
    distance_dice, proximity_dice, sparsity_dice, aps_dice = stat(hepatitis_dice)
    distance_cfmss, proximity_cfmss, sparsity_cfmss, aps_cfmss = stat_cfmss(hepatitis_cfmss)
    ...
    plt.savefig("Hepatitis.pdf", dpi = 600, bbox_inches = 'tight')
    plt.show()
