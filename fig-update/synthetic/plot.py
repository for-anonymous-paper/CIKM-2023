...
if __name__ == "__main__":
    ...
    distance_gs, proximity_gs, sparsity_gs, aps_gs = stat(synthetic_gs)
    distance_cfproto, proximity_cfproto, sparsity_cfproto, aps_cfproto = stat(synthetic_cfproto)
    distance_plaincf, proximity_plaincf, sparsity_plaincf, aps_plaincf = stat(synthetic_plaincf)
    distance_dice, proximity_dice, sparsity_dice, aps_dice = stat(synthetic_dice)
    distance_cfmss, proximity_cfmss, sparsity_cfmss, aps_cfmss = stat_cfmss(synthetic_cfmss)
    ...
    axs[0].set_title(r"Distance$\downarrow$")
    ...
    plt.savefig("synthetic.pdf", dpi = 600, bbox_inches = 'tight')
    plt.show()
